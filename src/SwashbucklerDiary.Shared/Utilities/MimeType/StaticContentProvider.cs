...
{
    public partial class StaticContentProvider
    {
        ...
        public static string GetResponseExtensionOrDefault(string contentType)
            => ContentTypeProvider.TryGetExtension(contentType, out var extension)
            ? extension
            : null;
