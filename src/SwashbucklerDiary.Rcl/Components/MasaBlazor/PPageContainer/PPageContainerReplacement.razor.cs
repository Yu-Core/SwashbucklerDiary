...
public partial class PPageContainerReplacement : PatternPathComponentBase
{
    ...
    [Parameter]
    public EventCallback<LocationChangedEventArgs> OnLocationChanged { get; set; }
    ...
    public void UpdatePatternPaths(PatternPath[] paths)
    {
        InvokeAsync(() =>
        {
            if (paths.Length == 0)
    ...
    private void NavigationManagerOnLocationChanged(object? sender, LocationChangedEventArgs e)
    {
        ...
        {
            OnLocationChanged.InvokeAsync(e);
        }
    }
